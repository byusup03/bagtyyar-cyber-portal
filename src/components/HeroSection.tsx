  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 border border-accent rounded-full animate-spin" style={{ animationDuration: '20s' }}></div>
        <div className="absolute top-3/4 right-1/4 w-32 h-32 border border-accent-glow rounded-full animate-spin" style={{ animationDuration: '15s', animationDirection: 'reverse' }}></div>
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="animate-fade-in">
          ...
          <div className="flex justify-center space-x-6 mb-16">
            <a
              href="mailto:bagtyyar@example.com"
              className="text-primary-foreground/60 hover:text-accent-glow transition-colors duration-300"
              aria-label="Email"
            >
              <Mail className="h-6 w-6" />
            </a>
            <a
              href="https://linkedin.com/in/bagtyyar"
              className="text-primary-foreground/60 hover:text-accent-glow transition-colors duration-300"
              aria-label="LinkedIn"
            >
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <Button
            ...
            className="text-primary-foreground/60 hover:text-accent-glow"
          >
